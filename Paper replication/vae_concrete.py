...
class VAE():
    ...
    """
    def __init__(self, input_shape=(28, 28, 1), latent_cont_dim=0,
    ...
    def _set_model(self):
        ...
        # Set up generator
        inputs_G = Input(batch_shape=(self.batch_size*2, self.latent_dim))
        x = G_0(inputs_G)
        x = G_1(x)
        x = G_2(x)
        x = G_3(x)
    ...
    def _sampling_concrete(self, args):
        ...
        """
        return sampling_concrete(args, (self.batch_size*2, self.latent_disc_dim))
